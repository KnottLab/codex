function display_stitched_HandE(J,Nx,Ny,I1,I2,I2r,reg_info,tform,H,h,W,w,Dx,Dy)



figure('Position',[1 41 1920 963],'Color','w')
subplot(1,2,1),imagesc(J),axis tight equal;set(gca,'Position',[0.01 0.2 0.475 0.6])
for x = 1:Nx; hold on,plot([1 size(J,2)],[x*h x*h]+Dx,'r','LineWidth',2); end
for y = 1:Ny; hold on,plot([y*w y*w]+Dy,[1 size(J,1)],'r','LineWidth',2); end
