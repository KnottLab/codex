...
for i = 31
    ...
    load(['./data/1_processed/',D.sampleID{i},'/CODEXobj_',D.sampleID{i},'.mat'],'CODEXobj'); disp(CODEXobj)
    ...
    imwrite(tissue_mask,['./outputs/3_Segmentation/',CODEXobj.sample_id,'/',CODEXobj.sample_id,'_1_tissue.tif'],'tif')
    ...
    mkdir(['./outputs/3_Segmentation/',CODEXobj.sample_id])
    save(['./outputs/3_Segmentation/',CODEXobj.sample_id,'/',CODEXobj.sample_id,'_CODEXobj.mat'],'CODEXobj','-v7.3'); disp(CODEXobj)
